...
public class MinhaLista
{
    ...
    public void addFilme(Filme filme)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Esse filme já está inserido na sua lista.");
        }
    }
    ...
    public String getFilmes(boolean printOnScreen)
    {
        ...
        else
        {
            if(printOnScreen)
            {
                JOptionPane.showMessageDialog(null, "Ainda não há filmes na sua lista.");
            }
            
            return "Ainda não há filmes na sua lista.";
        }
    }
    ...
    public void addSerie(Serie serie)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Essa série já está inserida na sua lista.");
        }
    }
    ...
    public String getSeries(boolean printOnScreen)
    {
        ...
        else
        {
            if(printOnScreen)
            {
                JOptionPane.showMessageDialog(null, "Ainda não há séries na sua lista.");
            }
            
            return "Ainda não há séries na sua lista.";
        }
    }
